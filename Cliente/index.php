...
<body class="z-1 overflow-auto">
	...
	<?php $mysqli=n ew mysqli( 'localhost', 'bruno', '123', 'hotel2') or die(myslqi_error($mysqli)); $result_quarto=$ mysqli->query("SELECT * FROM Quarto WHERE id NOT IN ( SELECT quarto_id FROM Reserva )") or die($mysqli->error); ?>
			...
			<form action="minhasreservas.php" method="POST">
				...
				<div class="row mt-16">
					<div class="ml-auto col-sm-auto">
						<button name="minhasreservas" type="submit" class="btn btn-warning"><span class="px-8 py-8">Avançar</span>
						</button>
					</div>
				</div>
			</form>
				...
				<div class="row mt-16 mb-8 mx-8">
					<div class="col-sm-auto">
						<form action="popReservaExistente.php" method="POST">
							...
							<button type="submit" class="btn btn-secondary text-light" name="reservarexistente"> <span class="px-8 py-8">Reservar Com Cadastro Existente</span>
							</button>
						</form>
					</div>
					<div class="col-sm-auto ml-auto">
						<form action="popReserva.php" method="POST">
							...
							<button type="submit" class="btn btn-warning" name="reservar"> <span class="px-8 py-8">Reservar</span>
							</button>
						</form>
					</div>
				</div>
