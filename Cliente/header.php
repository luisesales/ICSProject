<nav class="navbar navbar-expand-lg navbar-dark grad"> <a class="navbar-brand" href="index.php"><span class="icon icon-logo size-logo-header"></span></a>
	...
	<div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
		<ul data-pop="0" class="navbar-nav mr-auto d-none">
			...
			<li class="nav-item"> <a class="nav-link text-light" href="admQuartos.php">Gerenciar Quartos</a>
			</li>
			<li class="nav-item"> <a class="nav-link text-light call" data-item="0" data-function="0">Minhas reservas</a>
			</li>
		</ul>
		<ul data-pop="0" class="navbar-nav ml-auto d-none">
			<li data-function="1" class="nav-link change"> <a class="exit" data-toggle="sair">SAIR<span class="icon icon-exit "></span></a> 
			</li>
		</ul>
		<ul data-pop="1" class="navbar-nav mr-auto">
			<li class="nav-item"> <a class="nav-link text-light" href="index.php">Inicio <span class="sr-only">(página atual)</span></a>
			</li>
			<li class="nav-item"> <a class="nav-link text-light call" data-item="0" data-function="0" style="cursor: pointer;">Minhas reservas</a>
			</li>
		</ul>
