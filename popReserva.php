...
<body class="z-1 overflow-auto">
	...
	<div class="bg-pop z-2 w-100 h-100 d-block">
		<div class="popup z-3 pt-8 pb-16 px-16 mx-auto text-dark w-50 border bg-lightblue rounded">
			...
			<?php if(isset($_POST[ 'idquarto'])){ $idquarto=p reg_replace( '/\s+/', '', $_POST[ 'idquarto']); } ?>
				...
				<div class="row mt-16 mx-0 w-100 text-light">
					...
					<div class="row mx-0 w-100">
						...
						<div class="col-sm-auto col-12 pl-0 mx-0 mt-8">
							<h5>Quarto</h5>
							<input name="quarto_id" type="text" readonly="readonly" class="w-100 s-32 input" value="<?php echo $idquarto; ?>">
						</div>
