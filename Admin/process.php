...
if (isset($_POST['fazerreserva'])){
   ...
   if(strlen($cpf) == 11){
    ...
    echo "<script>alert('Reserva Feita com Sucesso!'); window.location.href='../Cliente/index.php';</script>";

}else{
    "<script>alert('Dados Incorretos'); window.location.href='../Cliente/index.php';</script>";
}
}
...
if (isset($_POST['fazerreservaexistente'])){
    ...
    if($hid == null || $hid == 0){
        echo "<script>alert('CPF Incorreto'); window.location.href='../Cliente/index.php';</script>";
    }else{
